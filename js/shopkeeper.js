...
var SHK = {
    ...
    showHelper: function( elem, name, noCounter, func ){
        ...
        if( noCounter ){
            ...
            this.setCounterToField( $('input:number','#shk_prodCount') );
        }
    ...
    setCounterToField: function( fields, callback ){
        ...
        if ( fields.length > 0 ) {
            ...
            fields.filter('.shk-count').each( function( i ){
                
                var el = $(this);
                
                if ( el.next('button.shk_count_button').length == 0 ) {
                    el.css( { display: 'inline-block' } );
                    if(el.hasClass('step_input')){el.before( '<button value="0.5" class="shk_count_button field-arr-down ' + SHK.options.buttons_class + '" type="button"></button>' );
                    el.after( '<button value="0.5" class="shk_count_button field-arr-up ' + SHK.options.buttons_class + '" type="button"></button>' );}
                    else{el.before( '<button value="1" class="shk_count_button field-arr-down ' + SHK.options.buttons_class + '" type="button"></button>' );
                    el.after( '<button value="1" class="shk_count_button field-arr-up ' + SHK.options.buttons_class + '" type="button"></button>' );}
                    ...
                    buttons.each( function( ii ){
                            ...
                            .click( function(){
                                    ...
                                    if( ii == 0 && cnt > 0.5 ) el.val( cnt - (parseFloat($(this).val())) );//вычитаем value кнопки
